# -*- coding: utf-8 -*-
"""
Created on Tue Mar 19 11:50:15 2024
...
image2 = image2.resize((950,900), Image.LANCZOS)
...
label_l1 = tk.Label(root, text="Electricity Demand Forecasting",font=("Times New Roman", 30, 'bold'),
...
frame_alpr = tk.LabelFrame(root, text="", width=600, height=702, bd=5, font=('times', 14, ' bold '),fg="white",bg="#79a8d8")
frame_alpr.grid(row=0, column=0, sticky='nw')
frame_alpr.place(x=0, y=100)


l1 = tk.Label(frame_alpr, text="Registration Form", font=("Times new roman", 30, "bold","italic"),bd=5, bg="black", fg="white")
l1.place(x=120, y=10)

# that is for label1 registration

l2 = tk.Label(frame_alpr, text="Full Name :", width=12, font=("Times new roman", 15, "bold"),bd=5, fg="black",bg="#79a8d8")
...
l3 = tk.Label(frame_alpr, text="Address :", width=12, font=("Times new roman", 15, "bold"),bd=5, fg="black",bg="#79a8d8")
...
l5 = tk.Label(frame_alpr, text="E-mail :", width=12, font=("Times new roman", 15, "bold"), bd=5,fg="black",bg="#79a8d8")
...
l6 = tk.Label(frame_alpr, text="Phone number :", width=12, font=("Times new roman", 15, "bold"),bd=5, fg="black",bg="#79a8d8")
...
l4 = tk.Label(frame_alpr, text="User Name :", width=12, font=("Times new roman", 15, "bold"), bd=5,fg="black",bg="#79a8d8")
l4.place(x=100, y=300)
t3 = tk.Entry(frame_alpr, textvar=username, width=20, font=('', 15))
t3.place(x=300, y=300)
# that is for label 4()

l9 = tk.Label(frame_alpr, text="Password :", width=12, font=("Times new roman", 15, "bold"),bd=5, fg="black",bg="#79a8d8")
l9.place(x=100, y=350)
t9 = tk.Entry(frame_alpr, textvar=password, width=20, font=('', 15), show="*")
t9.place(x=300, y=350)


l10 = tk.Label(frame_alpr, text="Confirm Password:", width=13, font=("Times new roman", 15, "bold"),bd=5, fg="black",bg="#79a8d8")
l10.place(x=100, y=400)
t10 = tk.Entry(frame_alpr, textvar=password1, width=20, font=('', 15), show="*")
t10.place(x=300, y=400)


btn = tk.Button(frame_alpr, text="Register", bg="#FAEBD7",relief="solid",font=("times new roman",20,"bold"),fg="black", width=9, height=1, bd=5,command=insert)
...
button1 = tk.Button(root, text="HOME", relief="solid",command=ho, width=12, height=1,font=('times 15 bold '),bd=0, bg="#3CB371", fg="black")
button1.place(x=635, y=250)

button2 = tk.Button(root, text="LOGIN",relief="solid",command=log,width=12, height=1,font=('times 15 bold '), bd=0,bg="#3CB371", fg="black")
button2.place(x=635, y=300)

button4 = tk.Button(root, text="EXIT",relief="solid", command=window, width=12, height=1,font=('times 15 bold '),bd=0,bg="#FF4500", fg="white")
button4.place(x=635, y=470)
